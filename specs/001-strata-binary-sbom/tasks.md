...
scans producing valid CycloneDX 1.6 + SPDX 2.3 with evidence + CVEs. On a 54-library real cross-compiler
benchmark: **Checkpoint A PASS** (100% precision, heuristics) and **Checkpoint B PASS** (embedding lifts
recall 77.6% to 90.2%, +16pts past the SC-004 bar; it ships, bundled in the corpus artefact and auto-loaded).
48 of 54 libraries at 100% precision and 100% recall incl mbedTLS and expat. AArch64 (Capstone) + x86-64
(Iced) both decode.
